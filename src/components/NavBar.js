        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              <Nav.Link href="#acceuil" className={activeLink === 'acceuil' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('acceuil')}>Acceuil</Nav.Link>
            ...
            <span className="navbar-text">
              ...
              <HashLink to='#connect'>
                <button className="vvd"><span>Me contactez</span></button>
              </HashLink>
            </span>
          </Navbar.Collapse>
        </Container>
